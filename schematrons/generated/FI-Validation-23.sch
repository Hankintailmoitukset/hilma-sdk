...
<assert id="FI-23-BT-811_a_-Lot-1" role="ERROR" test="count(efbc:LegalFrameworkCode) = 0 or (efbc:LegalFrameworkCode/normalize-space(text()) = ('gpp-crit','nzeb-bui'))">rule|text|FI-23-BT-811(a)-Lot-1</assert>
<assert id="FI-23-BT-811_b_-Lot-1" role="ERROR" test="count(efbc:AssetCategoryCode) = 0 or (efbc:AssetCategoryCode/normalize-space(text()) = ('building'))">rule|text|FI-23-BT-811(b)-Lot-1</assert>
</rule>
...
<assert id="FI-23-BT-811_a_-LotResult-1" role="ERROR" test="count(efbc:LegalFrameworkCode) = 0 or (efbc:LegalFrameworkCode/normalize-space(text()) = ('gpp-crit','nzeb-bui'))">rule|text|FI-23-BT-811(a)-LotResult-1</assert>
<assert id="FI-23-BT-811_b_-LotResult-1" role="ERROR" test="count(efbc:AssetCategoryCode) = 0 or (efbc:AssetCategoryCode/normalize-space(text()) = ('building'))">rule|text|FI-23-BT-811(b)-LotResult-1</assert>
</rule>
...
<rule context="/*/hilma:NationalExtension/hilma:NoticeResult/hilma:SettledContracts/hilma:SettledContract[$noticeSubType = '23']">
<assert id="FI-23-FI-70-1" role="ERROR" test="count(hilma:ContractValueAmount) = 0">rule|text|FI-23-FI-70-1</assert>
<assert id="FI-23-FI-OPT-100-Contract-1" role="ERROR" test="count(cbc:ID) = 0">rule|text|FI-23-FI-OPT-100-Contract-1</assert>
</rule>
</pattern>
