...
<assert id="FI-E4-BT-1118-NoticeResult-2" role="ERROR" test="count(efbc:OverallApproximateFrameworkContractsAmount) = 0 or (efac:LotResult/cbc:TenderResultCode[../efac:TenderLot/cbc:ID/normalize-space(text()) = ../../../../../../../cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cbc:ID[../cac:TenderingProcess/cac:ContractingSystem[cbc:ContractingSystemTypeCode/@listName='framework-agreement']/cbc:ContractingSystemTypeCode/normalize-space(text()) = ('fa-mix','fa-w-rc','fa-wo-rc')]/normalize-space(text())]/normalize-space(text()) = 'selec-w') or ((efac:LotResult/efac:FrameworkAgreementValues/efbc:ReestimatedValueAmount))">rule|text|FI-E4-BT-1118-NoticeResult-2</assert>
...
<assert id="FI-E4-BT-118-NoticeResult-2" role="ERROR" test="count(efbc:OverallMaximumFrameworkContractsAmount) = 0 or (efac:LotResult/cbc:TenderResultCode[../efac:TenderLot/cbc:ID/normalize-space(text()) = ../../../../../../../cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cbc:ID[../cac:TenderingProcess/cac:ContractingSystem[cbc:ContractingSystemTypeCode/@listName='framework-agreement']/cbc:ContractingSystemTypeCode/normalize-space(text()) = ('fa-mix','fa-w-rc','fa-wo-rc')]/normalize-space(text())]/normalize-space(text()) = 'selec-w') or ((efac:LotResult/efac:FrameworkAgreementValues/cbc:MaximumValueAmount))">rule|text|FI-E4-BT-118-NoticeResult-2</assert>
...
<assert id="FI-E4-BT-161-NoticeResult-2" role="ERROR" test="count(cbc:TotalAmount) = 0 or (efac:LotResult/cbc:TenderResultCode[../efac:TenderLot/cbc:ID/normalize-space(text()) = ../../../../../../../cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cbc:ID[(../cac:TenderingProcess/cac:ContractingSystem[cbc:ContractingSystemTypeCode/@listName='framework-agreement']/cbc:ContractingSystemTypeCode/normalize-space(text()) = ('fa-mix','fa-w-rc','fa-wo-rc'))]/normalize-space(text())]/normalize-space(text()) = 'selec-w') and (efac:SettledContract/efbc:ContractFrameworkIndicator = true())">rule|text|FI-E4-BT-161-NoticeResult-2</assert>
</rule>
...
<assert id="FI-E4-BT-506-Organization-Company-1" role="ERROR" test="count(cac:Contact/cbc:ElectronicMail) &gt; 0 or (cac:PartyIdentification/cbc:ID/normalize-space(text()) = ../../../../../../../cac:ContractingParty/cac:Party/cac:PartyIdentification/cbc:ID/normalize-space(text()))">rule|text|FI-E4-BT-506-Organization-Company-1</assert>
