...
<rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingProcess/cac:FrameworkAgreement[$noticeSubType = 'E3']">
<assert id="FI-E3-BT-109-Lot-1" role="ERROR" test="count(cbc:Justification) &gt; 0">rule|text|FI-E3-BT-109-Lot-1</assert>
</rule>
