...
<assert id="FI-E3-BT-536-Lot-1" role="ERROR" test="count(cbc:StartDate) &gt; 0 or not((not(cbc:DescriptionCode)) or (cbc:DescriptionCode and cbc:DescriptionCode/normalize-space(text()) = 'UNLIMITED'))">rule|text|FI-E3-BT-536-Lot-1</assert>
