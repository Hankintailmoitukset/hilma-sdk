...
<assert id="FI-E3-BT-52-Lot-1" role="ERROR" test="count(cbc:CandidateReductionConstraintIndicator) &gt; 0 or not(../../cac:TenderingProcess/cbc:ProcedureCode/normalize-space(text()) = ('comp-dial','innovation','neg-w-call'))">rule|text|FI-E3-BT-52-Lot-1</assert>
</rule>
...
<assert id="FI-E3-BT-740-Procedure-Buyer-1" role="ERROR" test="count(cac:ContractingPartyType/cbc:PartyTypeCode[@listName='buyer-contracting-type']) = 0">rule|text|FI-E3-BT-740-Procedure-Buyer-1</assert>
</rule>
<rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingProcess/cac:OpenTenderEvent[$noticeSubType = 'E3']">
<assert id="FI-E3-BT-132_d_-Lot-1" role="ERROR" test="count(cbc:OccurrenceDate) = 0">rule|text|FI-E3-BT-132(d)-Lot-1</assert>
<assert id="FI-E3-BT-132_t_-Lot-1" role="ERROR" test="count(cbc:OccurrenceTime) = 0">rule|text|FI-E3-BT-132(t)-Lot-1</assert>
</rule>
...
<assert id="FI-E3-BT-36-Lot-1" role="ERROR" test="count(cac:PlannedPeriod/cbc:DurationMeasure) &gt; 0 or not((not(cac:PlannedPeriod/cbc:DescriptionCode) and not(cac:PlannedPeriod/cbc:EndDate)))">rule|text|FI-E3-BT-36-Lot-1</assert>
<assert id="FI-E3-BT-536-Lot-1" role="ERROR" test="count(cac:PlannedPeriod/cbc:StartDate) &gt; 0 or not((not(cac:PlannedPeriod/cbc:DescriptionCode) or cac:PlannedPeriod/cbc:DescriptionCode/normalize-space(text()) = 'UNLIMITED'))">rule|text|FI-E3-BT-536-Lot-1</assert>
<assert id="FI-E3-BT-537-Lot-1" role="ERROR" test="count(cac:PlannedPeriod/cbc:EndDate) &gt; 0 or not((not(cac:PlannedPeriod/cbc:DescriptionCode) and not(cac:PlannedPeriod/cbc:DurationMeasure)))">rule|text|FI-E3-BT-537-Lot-1</assert>
</rule>
...
<assert id="FI-E3-BT-752-Lot-ThresholdNumber-1" role="ERROR" test="count(efac:CriterionParameter[efbc:ParameterCode/@listName='number-threshold']/efbc:ParameterNumeric) &gt; 0 or not(efac:CriterionParameter[efbc:ParameterCode/@listName='number-threshold']/efbc:ParameterCode)">rule|text|FI-E3-BT-752-Lot-ThresholdNumber-1</assert>
<assert id="FI-E3-BT-752-Lot-WeightNumber-1" role="ERROR" test="count(efac:CriterionParameter[efbc:ParameterCode/@listName='number-weight']/efbc:ParameterNumeric) &gt; 0 or not(efac:CriterionParameter[efbc:ParameterCode/@listName='number-weight']/efbc:ParameterCode)">rule|text|FI-E3-BT-752-Lot-WeightNumber-1</assert>
</rule>
...
<rule context="/*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/cac:TenderingTerms/cac:AllowedSubcontractTerms[cbc:SubcontractingConditionsCode/@listName='subcontracting-obligation'][$noticeSubType = 'E3']">
<assert id="FI-E3-BT-64-Lot-1" role="ERROR" test="count(cbc:MinimumPercent) = 0">rule|text|FI-E3-BT-64-Lot-1</assert>
...
<assert id="FI-E3-BT-811_a_-Lot-2" role="ERROR" test="count(efbc:LegalFrameworkCode) = 0 or not(efbc:LegalFrameworkCode/normalize-space(text()) = ('gpp-crit','nzeb-bui'))">rule|text|FI-E3-BT-811(a)-Lot-2</assert>
<assert id="FI-E3-BT-811_b_-Lot-1" role="ERROR" test="count(efbc:AssetCategoryCode) = 0">rule|text|FI-E3-BT-811(b)-Lot-1</assert>
<assert id="FI-E3-BT-811_b_-Lot-2" role="ERROR" test="count(efbc:AssetCategoryCode) = 0 or not(efbc:AssetCategoryCode/normalize-space(text()) = ('building'))">rule|text|FI-E3-BT-811(b)-Lot-2</assert>
</rule>
<rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:NoticeResult/efac:LotResult/efac:StrategicProcurement[efac:StrategicProcurementInformation/efac:ProcurementDetails/efbc:AssetCategoryCode/@listName='energy-efficiency-item']/efac:StrategicProcurementInformation/efac:ProcurementDetails[$noticeSubType = 'E3']">
<assert id="FI-E3-BT-811_a_-LotResult-1" role="ERROR" test="count(efbc:LegalFrameworkCode) = 0 or not(efbc:LegalFrameworkCode/normalize-space(text()) = ('gpp-crit','nzeb-bui'))">rule|text|FI-E3-BT-811(a)-LotResult-1</assert>
<assert id="FI-E3-BT-811_b_-LotResult-1" role="ERROR" test="count(efbc:AssetCategoryCode) = 0 or not(efbc:AssetCategoryCode/normalize-space(text()) = ('building'))">rule|text|FI-E3-BT-811(b)-LotResult-1</assert>
</rule>
...
<assert id="FI-E3-FI-11-1" role="ERROR" test="count(hilma:ApplicableLegislationCode) &gt; 0">rule|text|FI-E3-FI-11-1</assert>
...
<assert id="FI-E3-FI-OPT-100-Contract-1" role="ERROR" test="count(cbc:ID) = 0">rule|text|FI-E3-FI-OPT-100-Contract-1</assert>
</rule>
</pattern>
